      ...
      <form onSubmit={(e) => handleAddCardList(e)}>
        ...
        <div className="add-card-colors">
          <div>
            ...
            />
            <label htmlFor="pink" className="add-card-colors-square" style={{ background: ListColors.Pink }}></label>
          </div>
          <div>
            <input
              type="radio"
          ...
          <div>
            <input
              ...
              onChange={(e) => handleSetListColor(e)}
            />
            <label htmlFor="green" className="add-card-colors-square" style={{ background: ListColors.Green }}></label>
          </div>
          <div>
            <input
              type="radio"
          ...
          <div>
            <input
              ...
              onChange={(e) => handleSetListColor(e)}
            />
            <label htmlFor="mauve" className="add-card-colors-square" style={{ background: ListColors.Mauve }}></label>
          </div>
        </div>
